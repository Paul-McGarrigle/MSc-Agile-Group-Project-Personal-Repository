DROP DATABASE if exists group_project_ericsson_test;
...
INSERT INTO base_data ( `date_time`, `event_id`, `failure_class`, `ue_type`, `market`, `operator`, `cell_id`, `duration`, `cause_code`, `ne_version`, `imsi`)
    VALUES ( '2013-01-11', 1, 1, 1, 1, 1, 1, 1, 1, 1, 344930000000011);
    
INSERT INTO users ( `username`, `password`, `role`)
    VALUES ( "test user", "test_password", "System Administrator");
