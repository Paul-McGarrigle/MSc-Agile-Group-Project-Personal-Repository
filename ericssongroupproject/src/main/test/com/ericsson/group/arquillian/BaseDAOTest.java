...
public class BaseDAOTest {
    ...
    public final void test_baseService_All_Base() throws Exception {
        List<BaseData> testBase = (List<BaseData>) baseDAO.getAllBaseData();
    ...
    public final void test_baseService_IMSI_By_Cause_Code() throws Exception {
        List<BaseData> testBase = (List<BaseData>) baseDAO.getImsiByCauseCode(1);
        Assert.assertEquals(344930000000011L, testBase.get(0).getImsi());
    }
    ...
    public final void test_baseService_Base_Data_By_Date() throws Exception {
        ...
        List<BaseData> testBase = (List<BaseData>) baseDAO.getBaseDataByDate(sqlStartDate, sqlStartDate);
        Assert.assertEquals(344930000000011L, testBase.get(0).getImsi());
    }
    ...
    public final void test_baseService_Failures_By_Date() throws Exception {
        ...
        Long testBase =  baseDAO.getFailuresByDate(344930000000011L, sqlStartDate, sqlStartDate);
        Assert.assertEquals(Long.valueOf(1L), testBase);
    }

    @Test
    public final void test_baseService_Cause_Code_By_IMSI() throws Exception {
        List<BaseData> testBase = (List<BaseData>) baseDAO.getCauseCodeByImsi(344930000000011L);
    ...
    public final void test_baseService_Count_Model_Date() throws Exception{
        ...
        Long testBase =  baseDAO.countByModelAndDate("1",sqlStartDate,sqlStartDate);
    ...
    public final void test_baseService_Base_Count_Model_Event_Cause() throws Exception {
        List<BaseData> testBase = (List<BaseData>) baseDAO.countByModelEventIdCauseCode("test ue ue_type");
        Assert.assertNotNull(testBase);
    }

    @Test
    public final void test_baseService_Base_By_IMSI() throws Exception {
        List<BaseData> testBase = (List<BaseData>) baseDAO.getBaseDataByImsi(344930000000011L);
        Assert.assertNotNull(testBase);
    }
    ...
    public final void test_Num_Failures_Duration_By_Date() throws Exception {
        ...
        Collection<?>  testBase = baseDAO.getNumFailuresAndDurationByDate(sqlStartDate,sqlStartDate);
        Assert.assertNotNull(testBase);
    }
    ...
    public final void test_Top_10_IMSI() throws Exception {
        ...
        Collection<?>  testBase = baseDAO.top10imsi(sqlStartDate,sqlStartDate);
        Assert.assertNotNull(testBase);
    }
    ...
    public final void test_Top_10_Market_Operator_Cell() throws Exception {
        ...
        Collection<?>  testBase = baseDAO.top10MarketOperatorCell(sqlStartDate,sqlStartDate);
        Assert.assertNotNull(testBase);
    }

    @Test
    public final void test_All_Models() throws Exception {
        Collection<?>  testBase = baseDAO.allModels("test ue model");
        Assert.assertNotNull(testBase);
    }

    @Test
    public final void test_All_IMSI() throws Exception {
        Collection<?>  testBase = baseDAO.allIMSI(344930000000011L);
        Assert.assertNotNull(testBase);
    }
    ...
    public final void test_Count_All_Failures() throws Exception {
        java.util.Date date = sdf1.parse(startDate);
        java.sql.Date sqlStartDate = new java.sql.Date(date.getTime());
        Long  testBase = baseDAO.countAllFailures(sqlStartDate, sqlStartDate);
        Assert.assertEquals(Long.valueOf(1L), testBase);
    }
    ...
    public final void test_Duration_Group_Country() throws Exception {
        java.util.Date date = sdf1.parse(startDate);
        java.sql.Date sqlStartDate = new java.sql.Date(date.getTime());
        Collection<?> testBase = baseDAO.getDurationByDateGroupCountry(sqlStartDate, sqlStartDate);
        Assert.assertNotNull(testBase);
    }

    @Test
    public final void test_Imsi_Auto() throws Exception {
        Collection<?>  testBase = baseDAO.imsiAutoComplete(3449L);
        Assert.assertNotNull(testBase);
    }
}
